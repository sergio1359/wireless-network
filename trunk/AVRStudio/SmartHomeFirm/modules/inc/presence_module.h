...
X(PresenceRead,				0x57, presenceRead_Handler,		presenceModule_DataConf, 	PRESENCE_READ_MESSAGE_t,				false)	\
X(PresenceReadResponse,		0x58, presenceRead_Handler,		presenceModule_DataConf,	PRESENCE_READ_RESPONSE_MESSAGE_t,		false)	\
