...
#ifndef _MAC2_
const NIB_t PROGMEM_DECLARE(defaultNIB) =
{
...
const SIB_t PROGMEM_DECLARE(defaultSIB) =
{
  /* MAC parameters */
...
const CS_ReadOnlyItems_t PROGMEM_DECLARE(csReadOnlyItems) =
{
  /* MAC parameters */
...
const CS_MemoryItem_t PROGMEM_DECLARE(csMemoryItems[]) =
{
